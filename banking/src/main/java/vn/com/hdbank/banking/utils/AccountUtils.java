package vn.com.hdbank.banking.utils;
...
public class AccountUtils {
    ...
    public static final String ACCOUNT_CREDIT_SUCCESS_MESSSAGE = "User Account was credited successfully";
    ...
    public static String generateAccountNumber() {
        ...
        //covert the current and randomNumber to strings, then concatenat
